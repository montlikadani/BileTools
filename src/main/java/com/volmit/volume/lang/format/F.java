...
public class F {
	...
	private static final String NAMES[] = { "Thousand", "Million", "Billion", "Trillion", "Quadrillion", "Quintillion",
	...
	public static String cname(String clazz) {
		...
		for (Character i : clazz.toCharArray()) {
			codeName += Character.isUpperCase(i) ? "-" + Character.toLowerCase(i) : i;
		}
	...
	public static String mem(long mb) {
		return mb < 1024 ? f(mb) + " MB" : f(((double) mb / (double) 1024), 1) + " GB";
	}
